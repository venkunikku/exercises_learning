...
pickle_file_average_rate_index_all_states = '../data/fifty_state_quandle_data_avg_rate_change.pickle'
csv_file_path_for_quandle_data = '../data/quandle_data_from_pickle_code.csv'
generic_path = '../data/'
