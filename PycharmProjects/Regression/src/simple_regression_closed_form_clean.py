...
def pand():
    ...
    test_loading_test_data_from_pickle_data_frame = pd.read_pickle('/Users/venkuburagadda/PycharmProjects/Regression/src/data/housing_data_seed20.pickle')
    ...
    bedroom_rss = get_residual_sum_of_squares(train_input_feature_bedrooms,train_output,bedroom_intercept,bedroom_slope)
